 $(document).ready(function(){
        ...
        $('#tablaCocheras tbody').on('click','.btnEliminar',function(){

            var data = table.row($(this).parents('tr')).data();
           
            var idcochera = data["idcochera"];
        ...
        $("#btnGuardar").on('click',function(){
                ...
                if (txtNumero.length == ""){
                    alert('Debe Ingresar El Numero de Cochera..!');
                    return false;
                }
                ...
                var ddlEstatus = document.getElementById("ddlEstatus").value;
                if (ddlEstatus.length == ""){
