        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-itm active">Gestionar Cochera</li>
                </ol>
            </div>
...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="btn-agregar-propietarios btnAgregar">
            <button type="button" class="btn btn-info btn-sm mb-4" data-toggle="modal" data-target="#modal-gestionar-propietarios" data-dismiss="modal"><i class="fas fas-plus-square">Agregar Cochera</i></button>
        </div>
        <table id="tablaPropietarios" class="table table-striped table-bordered nowrap" style="width: 100%;">
            <thead class="btn-info">
                <tr>
                    <td style="width: 10%;">Id</td>
                    <td style="width: 15%;">Numero Cochera</td>                    
                    <td style="width: 15%;">Piso</td>
                    <td style="width: 10%;">Estaus</td>
    ...
    $(document).ready(function(){
        ...
        $('#tablaPropietarios tbody').on('click','.btnEditar',function(){
            var data = table.row($(this).parents('tr')).data();
                ...
                $("#txtNombre_Propietario").val(data["nombrep"]);
        ...
        $("#btnGuardar").on('click',function(){
                ...
                var id_propietario = $("#idpropietario").val(),
                    nombre_propietario =$("#txtNombre_Propietario").val();
                    identificacion =$("#txtIdentificacion").val();

                var datos = new FormData();
                    datos.append('idpropietario',id_propietario);
